...
/*----------------------------------------*/
	...
	$(".li-countdown").each(function(){
		...
		var date = $(this).attr("data-endat");

		$(this).countdown(date, function(event) {
			$(this).html(
			  event.strftime('<div class="count">%D j</div> <div class="count">%H h</div> <div class="count">%M m</div><div class="count"> %S s</div>')
			);
		  });
	});
...
/*
   $(".li-countdown")
     .countdown("2022/12/01", function(event) {
       $(this).html(
         event.strftime('<div class="count">%D <span>Jours:</span></div> <div class="count">%H <span>Heures:</span></div> <div class="count">%M <span>Mins:</span></div><div class="count"> %S <span>Secs</span></div>')
       );
     });
*/
/*----------------------------------------*/
