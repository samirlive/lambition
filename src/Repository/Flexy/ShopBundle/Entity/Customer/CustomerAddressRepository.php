...
namespace App\Repository\Flexy\ShopBundle\Entity\Customer;
...
class CustomerAddressRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(CustomerAddress $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(CustomerAddress $entity, bool $flush = true): void
    {
